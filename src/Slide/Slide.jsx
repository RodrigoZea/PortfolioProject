...
export default class Slide extends React.Component {
    render() {
        const { slideImg, numberTxt, subtitle, subtitleJp, direction, title, description, color } = this.props
        ...
        return (
            <div className={"slide " + `${direction}`}>
                ...
                <div className={"slideInfoContainer " + `${direction}`}> 
                    ...
                    <div className="slideSubJp" style={{ color: `${color}` }}> 
                        {subtitleJp}
                    </div>
                    <div className="slideSub" style={{ color: `${color}` }}>
                        {subtitle}
                    </div>
                </div>
